...
class DLog {
  ...
  // 内部打印方法
  static String _printLog(
      String level, dynamic message, String ansiColor, String webColor) {
  ...
  // 原生平台的打印实现
  static String _printLogNative(
      String level, String message, String ansiColor) {
